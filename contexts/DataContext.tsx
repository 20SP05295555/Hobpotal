...
import { CompanyInfo, Customer, Order, OrderItem } from '../types';
import { COMPANY_INFO, CURRENT_CUSTOMER, SAMPLE_ORDER } from '../constants';
...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const updateOrderItem = (index: number, field: keyof OrderItem, value: any) => {
    ...
    // Auto-calc line total if quantity or price changes
